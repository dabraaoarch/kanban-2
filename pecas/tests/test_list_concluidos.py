...
class AbastecimentosConcluidosTests(TestCase):
    def setUp(self):
    ...
    def test_abastecimento_concluido_status_code(self):
        '''
    ...
    def test_abastecimento_concluidos_render_view(self):
        '''
        Checks if the page is rendered according to the view
        '''
        view = resolve('/pecas/abastecimento/concluidos/')
        self.assertEquals(view.func.view_class, PedidosListView)

    def test_abastecimento_concluido_without_itens(self):
        '''
    ...
    def test_abastecimento_concluidos_with_itens(self):
        '''
    ...
    def test_abastecimento_concluido_with_itens_in_other_status(self):
        '''
    ...
    def test_abastecimento_concluidos_context(self):
        '''
        If there were itens in the database it should display
        a table with a link to remove the item
        '''
    ...
    def test_abastecimento_concluidos_links(self):
        '''
    ...
    def test_abastecimentos_concluidos_move_pedido(self):
        '''
    ...
    def test_abastecimentos_concluidos_move_pedido_wrong_status(self):
        '''
    ...
    def test_abastecimentos_concluidos_move_pedido_invalid_data(self):
        '''
